      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto">
          <ul className="flex flex-col gap-1.5">
            ...
            <li>
              <NavLink to="/patient/dashboard" className={linkClass} onClick={() => setIsOpen(false)}>
            ...
            <li>
              <NavLink to="/patient/book-appointment" className={linkClass} onClick={() => setIsOpen(false)}>
